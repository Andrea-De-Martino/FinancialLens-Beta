...
class DataValidator:
    ...
    def _recursive_recalculate_totals(self, data: Dict[str, Any]) -> None:
        ...
        To note that nodes enriched from Nota Integrativa should not have 
        their totals recalculated since they contain authoritative values 
        from supplementary documentation.
