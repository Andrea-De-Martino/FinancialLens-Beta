...
class FinancialReclassifier:
    """
    Handles reclassification of Italian financial statements.
    
    This module transforms parsed Italian financial statement data (Stato Patrimoniale 
    and Conto Economico) into standardized reclassified format with P&L, Assets, and 
    Liabilities sections. The reclassification follows mapping rules and 
    performs cascading calculations.
    ...
    3. Maps Italian accounting items
    ...
    6. Generates calculation trails for transparency
    
    The system handles the Italian accounting hierarchy and transforms
    ...
    def reclassify_financial_data(self, financial_data: Dict[str, Any]) -> ReclassificationResult:
        """
        Reclassify complete financial statement data into reclassified format.
        
        This method orchestrates the complete reclassification process, transforming
        Italian financial statement structure into reclassified P&L, Assets, and
        Liabilities format.
        
        The process includes:
        1. Flattening hierarchical data structure
        2. Mapping Italian items to reclassified equivalents
        3. Performing cascading calculations for derived items
    ...
    def _load_mapping_configuration(self) -> Dict[str, Dict[str, Any]]:
        ...
        It processes both Stato Patrimoniale and Conto Economico sheets 
        to create a unified mapping configuration with parent-child relationships.
        ...
        try:
            ...
            # Print actual column names for debug
    ...
    def _flatten_financial_data(self, data: Dict[str, Any]) -> Dict[str, float]:
        ...
        traversing the nested financial statement structure and extracting
    ...
    def _perform_cascading_calculations(self, mapped_totals: Dict[str, float], 
        ...
        """
        Perform cascading calculations for international format.
