...
class TextProcessor:
    ...
    This module encapsulates the text processing capabilities
    that form the core of the financial statement parsing system. It manages
    the process of matching raw PDF text against the structured
    ...
    The disambiguation logic is quite complex, using hierarchical
    ...
    def normalize_text(self, text: Any, for_matching: bool = False) -> str:
        ...
        he normalization process is used for consistent matching behavior, 
        as it standardizes the text format to handle variations in whitespace, 
    ...
    def disambiguate_candidates(self, candidates: List[MatchCandidate], 
        ...
        It implements a context-aware strategy that considers the 
        hierarchical position within the financial statement structure 
    ...
    def is_ignorable_text(self, text: str) -> bool:
        ...
        The ignore functionality is important for filtering out
