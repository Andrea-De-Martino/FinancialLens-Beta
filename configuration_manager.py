...
class ConfigurationManager:
    ...
    This class centralizes configuration management for the financial statement
    ...
    def _create_contextual_and_parent_configs(self) -> Tuple[Dict[str, Dict[str, List[str]]], Dict[str, str]]:
        ...
        It generates the complex inverted configuration mappings and parent 
        relationships that are critical for the hierarchical FS processing.
    ...
    def get_pdf_extractor_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'consolidated_format_indicators': pdf_config.get('consolidated_format_indicators', [])
    ...
    def get_reclassification_status(self) -> Dict[str, Any]:
        ...
        Provides information about the availability and
    ...
    def validate_configuration(self) -> bool:
        ...
        for proper parser operation, including validation for reclassification.
        ...
        if not self.reclassification_available:
            ...
            # This is not a failure condition as reclassification is an enhancement
