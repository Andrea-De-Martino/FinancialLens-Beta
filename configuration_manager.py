...
class ConfigurationManager:
    ...
    def get_pdf_extractor_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'section_patterns': {
                'stato_patrimoniale': r'\b(stato\s+patrimoniale)\b',
                'conto_economico': r'\b(conto\s+economico)\b'
            },
    ...
    def get_enrichment_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'enrichment_score_threshold': settings.get('enrichment_score_threshold', 85),
            'enrichment_high_confidence_threshold': 95,
    ...
    def get_output_settings(self) -> Dict[str, Any]:
        ...
        return {
            'output_prefixes': {
                'success': '',
                'success_with_tolerance': 'SuccessWithTol_',
                'failed': 'Failed_'
            },
            'retry_settings': {
                'max_attempts': 3,
                'ni_search_page_limit': 20
            }
        }
