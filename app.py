...
def display_brsf_table(result: Dict[str, Any], filename: str):
    ...
    # RIMUOVIAMO i seguenti items dalla lista calculated_items per renderli normali:
    # 'GROSS PROFIT', 'NET OP. PROFIT', 'TOT CURR. ASS.', 'TOTAL FIX. ASS.', 'TOT CURR. LIAB.', 'TOTAL LT LIAB'
    calculated_items = {
        'Cost of Sales', 'S G & A', 
        'PRE TAX PROFIT', 'PROFIT AFTER TAX', 'Quick Assets', 'Other Current',
        'Financial/Other fix Ass', 
        'BAL. SHEET TOT', 'Total Short Term Debt',
        'Sub. Loan/Oth. LT', 'Liabs less net worth',
        'TOT NET WORTH'
    }
    ...
    for col, section in zip(columns, sections):
        with col:
            ...
            for item in section_structure:
                ...
                # MODIFICA: Quando mostriamo i valori /1000, arrotondiamo senza decimali
